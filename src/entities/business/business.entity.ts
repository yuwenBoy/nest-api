...
import { BusinessAuditEntity } from './business_audit.entity';
...
export class BusinessEntity extends BusinessBaseEntity{ 
    ...
    @Column({type:'enum',default:BusinessStatusEnum.APPLYIN,enum:BusinessStatusEnum, name: 'status',comment:'状态'})
    ...
    @OneToOne(() => BusinessAuditEntity, audit => audit.business, {
        eager: false,
        cascade: false,
      })
